                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <b-dropdown title="Click for 'Do IT' or click dropdown for another option" id="ddown-split" @click="doShort()" split text="Do it or -> " size="lg" class="">
                          <b-dropdown-item v-if="( custom_link == false )" @click="(input_custom_link = '', custom_link = true)" href="#">Use Custom Link</b-dropdown-item>
                          <b-dropdown-item v-if="( custom_link == true )" @click="(input_custom_link = '', custom_link = false)" href="#">Use Random</b-dropdown-item>
                        </b-dropdown>
                    </div>
                </div>
            </form>
